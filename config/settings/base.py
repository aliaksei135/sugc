...
)  # (sugc/config/settings/base.py - 3 = sugc/)
APPS_DIR = ROOT_DIR.path("sugc")
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/sugc")
}
...
MIGRATION_MODULES = {"sites": "sugc.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sugc.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Aliaksei Pilko""", "aliaksei@aliakseipilko.com")]
